 ...
 * {@link DirectionFragment.DirectionFragmentListener} interface
...
public class DirectionFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof DirectionFragmentListener) {
            mListener = (DirectionFragmentListener) context;
        } else {
     ...
     */
    public interface DirectionFragmentListener {
